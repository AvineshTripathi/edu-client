...
If it is not yet considered then please create a new issue in the GitHub repository[new-issue] describing your enhancement.
...
3. Fill the template completely by describing your changes, cause of those changes, issues getting fixed etc.
